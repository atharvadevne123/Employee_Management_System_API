...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-dev-key-change-in-production-abc123"
)
...
LOGGING = {
    ...
    "loggers": {
        "employees": {"handlers": ["console"], "level": "DEBUG", "propagate": False},
        "attendance": {"handlers": ["console"], "level": "DEBUG", "propagate": False},
    },
}
